...
public class Element : MonoBehaviour, IPointerDownHandler, IDragHandler, IPointerUpHandler
{
    [SerializeField] private ChemistryElementData _data;
    ...
    private void Awake()
    {
        ...
        _elementNameText.text = _data.elementName.ToString();
    }
